<section class="bg-light">
    <div class="container">
        <div class="structure-hero pt-lg-5 pt-4">
            <h1 class="titre text-center">Détail du rapport de visite (Historique)</h1>
        ...
        <div class="row justify-content-center py-4">
            <div class="col-12 col-lg-10">
                ...
                <div class="card shadow mb-3">
                    <div class="card-header bg-info text-light">
                        <h5 class="mb-0"><i class="bi bi-person-badge"></i> Praticien visité</h5>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="col-md-4 text-end">
                                <a href="index.php?uc=praticien&action=afficherpraticien&praticien=<?php echo $rapport['PRA_NUM']; ?>" 
                                   class="btn btn-outline-info">
                                    <i class="bi bi-eye"></i> Voir la fiche praticien
                                </a>
                            </div>
                        </div>
                                        ...
                                        <div class="border rounded p-3 h-100">
                                            ...
                                            <a href="index.php?uc=medicaments&action=affichermedoc&medicament=<?php echo $rapport['MED_DEPOTLEGAL_1']; ?>" 
                                               class="btn btn-sm btn-outline-info">
                                                <i class="bi bi-eye"></i> Voir la fiche médicament
                                            </a>
                                        </div>
                                    </div>
                                <?php endif; ?>
                ...
                <?php if (!empty($echantillons)): ?>
                    <div class="card shadow mb-3">
                        <div class="card-header bg-info text-light">
                            <h5 class="mb-0"><i class="bi bi-gift"></i> Échantillons offerts</h5>
                        </div>
                        <div class="card-body">
                                        ...
                                        <?php foreach ($echantillons as $ech): ?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <span class="badge bg-info"><?php echo $ech['OFF_QTE']; ?></span>
                                                </td>
                                                <td class="text-end">
                ...
                <div class="card shadow mb-3">
                    <div class="card-header bg-info text-light">
                        <h5 class="mb-0"><i class="bi bi-chat-left-text"></i> Bilan de la visite</h5>
                    </div>
                    <div class="card-body">
