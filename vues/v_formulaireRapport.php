        ...
        <div class="row justify-content-center py-4">
            <div class="col-12 col-lg-10 col-xl-8">
                <form action="index.php?uc=rapport&action=enregistrer" method="post" class="formulaire p-4">
                    ...
                    <!-- Date de visite -->
                    <div class="mb-3">
                        <label for="date_visite" class="form-label carac">Date de visite <span class="text-danger">*</span></label>
                    ...
                    <!-- Praticien visité -->
                    <div class="mb-3">
                        <label for="praticien" class="form-label carac">Praticien visité <span class="text-danger">*</span></label>
                    ...
                    <div class="mb-3">
                        <label for="praticien_remplacant" class="form-label carac">Praticien remplaçant (si applicable)</label>
                    ...
                    <!-- Motif de la visite -->
                    <div class="mb-3">
                        <label for="motif" class="form-label carac">Motif de la visite <span class="text-danger">*</span></label>
                    ...
                    <div class="mb-3" id="div_autre_motif" style="display:<?php echo (isset($motifRapport) && $motifRapport == 5) ? 'block' : 'none'; ?>;">
                        <label for="autre_motif" class="form-label carac">Précisez le motif <span class="text-danger">*</span></label>
                    ...
                    <!-- Bilan de la visite -->
                    <div class="mb-3">
                        <label for="bilan" class="form-label carac">Bilan de la visite <span class="text-danger">*</span></label>
                    ...
                    <div class="mb-3">
                        ...
                        <p class="text-muted small">Indiquez la quantité d'échantillons distribués pour chaque médicament</p>
                    ...
                    <div class="mb-3 form-check">
                        <input type="checkbox" class="form-check-input" id="saisie_definitive" name="saisie_definitive" value="1">
