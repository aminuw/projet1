<section class="bg-light">
    <div class="container">
        <div class="structure-hero pt-lg-5 pt-4">
            <h1 class="titre text-center">Informations du praticien <span
                    class="carac"><?php echo $infos['Prenom'] . ' ' . $infos['Nom']; ?></span></h1>
        </div>
        <div class="row align-items-center justify-content-center">
            ...
            <div class="test col-12 col-sm-8 col-lg-6 col-xl-5 col-xxl-4 py-lg-5 py-3">
                ...
                if (!empty($infos)): ?>
                        ...
                        <p><span class="carac">Spécialitée(s)</span> :
                            <?php if (!empty($specialite)) {
                                echo implode(', ', $specialite);
                            } else {
                                echo 'Aucune(s) spécialitée(s)';
                            } ?>
                        </p>
                    ...
                    <?php endif; ?>
                    <input class="btn btn-info text-light valider col-6 col-sm-5 col-md-4 col-lg-3" type="button"
                        onclick="history.go(-1)" value="Retour">
                </div>
            </div>
        </div>
    </div>
