...
INSERT INTO `praticien` (`PRA_NUM`, `PRA_PRENOM`, `PRA_NOM`, `PRA_ADRESSE`, `PRA_CP`, `PRA_VILLE`, `PRA_COEFNOTORIETE`, `TYP_CODE`, `SPE_CODE`) VALUES
...
ALTER TABLE `praticien`
  ADD CONSTRAINT `fk_spe_code` FOREIGN KEY (`SPE_CODE`) REFERENCES `specialite` (`SPE_CODE`),
