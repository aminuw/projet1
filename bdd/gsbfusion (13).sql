...
--
-- Hôte : 127.0.0.1:3307
-- Généré le : mar. 16 déc. 2025 à 10:03
...
('a55', 'Bedos', 'Christian', '1 r Bénédictins', '65000', 'TARBES', '1987-07-17 00:00:00', 3, 'S', 'OC'),
...
('b16', 'Bioret', 'Luc', '1 r Linne', '35000', 'RENNES', '1997-03-21 00:00:00', 2, 'O', 'BG'),
...
CREATE TABLE IF NOT EXISTS `praticien` (
  ...
  `PRA_COEFCONF` float DEFAULT NULL,
  PRIMARY KEY (`PRA_NUM`),
...
INSERT INTO `praticien` (`PRA_NUM`, `PRA_PRENOM`, `PRA_NOM`, `PRA_ADRESSE`, `PRA_CP`, `PRA_VILLE`, `PRA_COEFNOTORIETE`, `TYP_CODE`, `PRA_COEFCONF`) VALUES
(1, 'Alain', 'Notini', '114 r Authie', '85000', 'LA ROCHE SUR YON', 290.03, 'MH', 854.2),
(2, 'Albert', 'Gosselin', '13 r Devon', '41000', 'BLOIS', 307.49, 'MV', 123.4),
(3, 'André', 'Delahaye', '36 av 6 Juin', '25000', 'BESANCON', 185.79, 'PS', 450),
(4, 'André', 'Leroux', '47 av Robert Schuman', '60000', 'BEAUVAIS', 172.04, 'PH', 67.8),
(5, 'Anne', 'Desmoulins', '31 r St Jean', '30000', 'NIMES', 94.75, 'PO', 999),
(6, 'Anne', 'Mouel', '27 r Auvergne', '80000', 'AMIENS', 45.2, 'MH', 345.6),
(7, 'Antoine', 'Desgranges-Lentz', '1 r Albert de Mun', '29000', 'MORLAIX', 20.07, 'MV', 12.5),
(8, 'Arnaud', 'Marcouiller', '31 r St Jean', '68000', 'MULHOUSE', 396.52, 'PS', 789.3),
(9, 'Benoit', 'Dupuy', '9 r Demolombe', '34000', 'MONTPELLIER', 395.66, 'PH', 234.5),
(10, 'Bernard', 'Lerat', '31 r St Jean', '59000', 'LILLE', 257.79, 'PO', 567.8),
(11, 'Bertrand', 'Marçais-Lefebvre', '86Bis r Basse', '67000', 'STRASBOURG', 450.96, 'MH', 876.5),
(12, 'Bruno', 'Boscher', '94 r Falaise', '10000', 'TROYES', 356.14, 'MV', 432.1),
(13, 'Catherine', 'Morel', '21 r Chateaubriand', '75000', 'PARIS', 379.57, 'PS', 111.2),
(14, 'Chantal', 'Guivarch', '4 av Gén Laperrine', '45000', 'ORLEANS', 114.56, 'PH', 654.3),
(15, 'Christophe', 'Bessin-Grosdoit', '92 r Falaise', '6000', 'NICE', 222.06, 'PO', 987.6),
(16, 'Claire', 'Rossa', '14 av Thiès', '6000', 'NICE', 529.78, 'MH', 55.4),
(17, 'Denis', 'Cauchy', '5 av Ste Thérèse', '11000', 'NARBONNE', 458.82, 'MV', 333.3),
(18, 'Dominique', 'Gaffé', '9 av 1ère Armée Française', '35000', 'RENNES', 213.4, 'PS', 777.8),
(19, 'Dominique', 'Guenon', '98 bd Mar Lyautey', '44000', 'NANTES', 175.89, 'PH', 222.1),
(20, 'Dominique', 'Prévot', '29 r Lucien Nelle', '87000', 'LIMOGES', 151.36, 'PO', 444.5),
(21, 'Eliane', 'Houchard', '9 r Demolombe', '49100', 'ANGERS', 436.96, 'MH', 88.9),
(22, 'Elisabeth', 'Desmons', '51 r Bernières', '29000', 'QUIMPER', 281.17, 'MV', 666.7),
(23, 'Elisabeth', 'Flament', '11 r Pasteur', '35000', 'RENNES', 315.6, 'PS', 10.05),
(24, 'Emmanuel', 'Goussard', '9 r Demolombe', '41000', 'BLOIS', 40.72, 'PH', 500),
(25, 'Eric', 'Desprez', '9 r Vaucelles', '33000', 'BORDEAUX', 406.85, 'PO', 250.2),
(26, 'Evelyne', 'Coste', '29 r Lucien Nelle', '19000', 'TULLE', 441.87, 'MH', 750.7),
(27, 'Frédéric', 'Lefebvre', '2 pl Wurzburg', '55000', 'VERDUN', 573.63, 'MV', 900),
(28, 'Frédéric', 'Lemée', '29 av 6 Juin', '56000', 'VANNES', 326.4, 'PS', 15.1),
(29, 'Frédéric', 'Martin', 'Bât A 90 r Bayeux', '70000', 'VESOUL', 506.06, 'PH', 85.8),
(30, 'Frédérique', 'Marie', '172 r Caponière', '70000', 'VESOUL', 313.31, 'PO', 623.4),
(31, 'Geneviève', 'Rosenstech', '27 r Auvergne', '75000', 'PARIS', 366.82, 'MH', 412.3),
(32, 'Ghislaine', 'Pontavice', '8 r Gaillon', '86000', 'POITIERS', 265.58, 'MV', 96.3),
(33, 'Guillaume', 'Leveneur-Mosquet', '47 av Robert Schuman', '64000', 'PAU', 184.97, 'PS', 741.2),
(34, 'Guy', 'Blanchais', '30 r Authie', '8000', 'SEDAN', 502.48, 'PH', 852.1),
(35, 'Hugues', 'Leveneur', '7 pl St Gilles', '62000', 'ARRAS', 7.39, 'PO', 963.2),
(36, 'Isabelle', 'Mosquet', '22 r Jules Verne', '76000', 'ROUEN', 77.1, 'MH', 147.2),
(37, 'Jean-Christophe', 'Giraudon', '1 r Albert de Mun', '38100', 'VIENNE', 92.62, 'MV', 258.3),
(38, 'Jean-Claude', 'Marie', '26 r Hérouville', '69000', 'LYON', 120.1, 'PS', 369.1),
(39, 'Jean-François', 'Maury', '5 r Pierre Girard', '71000', 'CHALON SUR SAONE', 13.73, 'PH', 753.9),
(40, 'Jean-Louis', 'Dennel', '7 pl St Gilles', '28000', 'CHARTRES', 550.69, 'PO', 159.3),
(41, 'Jean-Pierre', 'Ain', '4 résid Olympia', '2000', 'LAON', 5.59, 'MH', 951.7),
(42, 'Jean-Pierre', 'Chemery', '51 pl Ancienne Boucherie', '14000', 'CAEN', 396.58, 'MV', 357.1),
(43, 'Jean-Pierre', 'Comoz', '35 r Auguste Lechesne', '18000', 'BOURGES', 340.35, 'PS', 500),
(44, 'Jean-Pierre', 'Desfaudais', '7 pl St Gilles', '29000', 'BREST', 71.76, 'PH', 852.4),
(45, 'JérÃ´me', 'Phan', '9 r Clos Caillet', '79000', 'NIORT', 451.61, 'PO', 10.5),
(46, 'Line', 'Riou', '43 bd Gén Vanier', '77000', 'MARNE LA VALLEE', 193.25, 'MH', 505.5),
(47, 'Louis', 'Chubilleau', '46 r Eglise', '17000', 'SAINTES', 202.07, 'MV', 789.6),
(48, 'Lucette', 'Lebrun', '178 r Auge', '54000', 'NANCY', 410.41, 'PS', 321.4),
(49, 'Marc', 'Goessens', '6 av 6 Juin', '39000', 'DOLE', 548.57, 'PH', 654.7),
(50, 'Marc', 'Laforge', '5 résid Prairie', '50000', 'SAINT LO', 265.05, 'PO', 987.1),
(51, 'Marc', 'Millereau', '36 av 6 Juin', '72000', 'LA FERTE BERNARD', 430.42, 'MH', 159.7),
(52, 'Marie-Christine', 'Dauverne', '69 av Charlemagne', '21000', 'DIJON', 281.05, 'MV', 753.1),
(53, 'Myriam', 'Vittorio', '3 pl Champlain', '94000', 'BOISSY SAINT LEGER', 356.23, 'PS', 852.3),
(54, 'Nhieu', 'Lapasset', '31 av 6 Juin', '52000', 'CHAUMONT', 107, 'PH', 951.2),
(55, 'Nicole', 'Plantet-Besnier', '10 av 1ère Armée Française', '86000', 'CHATELLEREAULT', 369.94, 'PO', 258.9),
(56, 'Pascal', 'Chubilleau', '3 r Hastings', '15000', 'AURRILLAC', 290.75, 'MH', 369.8),
(57, 'Pascal', 'Robert', '31 r St Jean', '93000', 'BOBIGNY', 162.41, 'MV', 147.5),
(58, 'Pascale', 'Jean', '114 r Authie', '49100', 'SAUMUR', 375.52, 'PS', 654.1),
(59, 'Patrice', 'Chanteloube', '14 av Thiès', '13000', 'MARSEILLE', 478.01, 'PH', 753.8),
(60, 'Patrice', 'Lecuirot', 'résid St Pères 55 r Pigacière', '54000', 'NANCY', 239.66, 'PO', 852.9),
(61, 'Patrick', 'Gandon', '47 av Robert Schuman', '37000', 'TOURS', 599.06, 'MH', 951.3),
(62, 'Patrick', 'Mirouf', '22 r Puits Picard', '74000', 'ANNECY', 458.42, 'MV', 159.4),
(63, 'Philippe', 'Boireaux', '14 av Thiès', '10000', 'CHALON EN CHAMPAGNE', 454.48, 'PS', 258.7),
(64, 'Philippe', 'Cendrier', '7 pl St Gilles', '12000', 'RODEZ', 164.16, 'PH', 369.2),
(65, 'Philippe', 'Duhamel', '114 r Authie', '34000', 'MONTPELLIER', 98.62, 'PO', 456.8),
(66, 'Philippe', 'Grigy', '15 r Mélingue', '44000', 'CLISSON', 285.1, 'MH', 789.1),
(67, 'Philippe', 'Linard', '1 r Albert de Mun', '81000', 'ALBI', 486.3, 'MV', 321.6),
(68, 'Philippe', 'Lozier', '8 r Gaillon', '31000', 'TOULOUSE', 48.4, 'PS', 654.9),
(69, 'Pierre', 'Dechâtre', '63 av Thiès', '23000', 'MONTLUCON', 253.75, 'PH', 987.3),
(70, 'Pierre', 'Goessens', '22 r Jean Romain', '40000', 'MONT DE MARSAN', 426.19, 'PO', 159.6),
(71, 'Pierre', 'Leménager', '39 av 6 Juin', '57000', 'METZ', 118.7, 'MH', 753.2),
(72, 'Pierre', 'Née', '39 av 6 Juin', '82000', 'MONTAUBAN', 72.54, 'MV', 852.1),
(73, 'Pierre-Laurent', 'Guyot', '43 bd Gén Vanier', '48000', 'MENDE', 352.31, 'PS', 951),
(74, 'Roger', 'Chauchard', '9 r Vaucelles', '13000', 'MARSEILLE', 552.19, 'PH', 258.4),
(75, 'Roland', 'Mabire', '11 r Boutiques', '67000', 'STRASBOURG', 422.39, 'PO', 369.7),
(76, 'Soazig', 'Leroy', '45 r Boutiques', '61000', 'ALENCON', 570.67, 'MH', 147.8),
(77, 'Stéphane', 'Guyot', '26 r Hérouville', '46000', 'FIGEAC', 28.85, 'MV', 654.2),
(78, 'Sylvain', 'Delposen', '39 av 6 Juin', '27000', 'DREUX', 292.01, 'PS', 789.9),
(79, 'Sylvie', 'Rault', '15 bd Richemond', '2000', 'SOISSON', 526.6, 'PH', 321.1),
(80, 'Sylvie', 'Renouf', '98 bd Mar Lyautey', '88000', 'EPINAL', 425.24, 'PO', 987.4),
(81, 'Thierry', 'Alliet-Grach', '14 av Thiès', '7000', 'PRIVAS', 451.31, 'MH', 1),
(82, 'Thierry', 'Bayard', '92 r Falaise', '42000', 'SAINT ETIENNE', 271.71, 'MV', 753.6),
(83, 'Thierry', 'Gauchet', '7 r Desmoueux', '38100', 'GRENOBLE', 406.1, 'PS', 852.7),
(84, 'Tristan', 'Bobichon', '219 r Caponière', '9000', 'FOIX', 218.36, 'PH', 24.5),
(85, 'Véronique', 'Duchemin-Laniel', '130 r St Jean', '33000', 'LIBOURNE', 265.61, 'PO', 312.8),
(86, 'Younès', 'Laurent', '34 r Demolombe', '53000', 'MAYENNE', 496.1, 'MH', 645.9);
...
CREATE TABLE IF NOT EXISTS `prescrire` (
  ...
  `DOS_CODE` int(11) NOT NULL,
  `PRE_POSTOLOGIE` varchar(5) DEFAULT NULL,
...
('a131', 5, '2025-10-28', 'test', 1, 15, NULL, NULL, NULL, '', 2),
...
('a131', 14, '2025-12-09', 'Test', 1, 81, NULL, NULL, NULL, '', 1),
('a131', 15, '2020-12-08', 'Test médicament et echantillion\r\n', 3, 56, NULL, 'AMOPIL7', NULL, '', 2),
('a131', 16, '2025-12-09', 'Test echantillion', 3, 81, NULL, NULL, NULL, '', 2),
('a131', 17, '2024-12-12', 'Test médicament', 1, 56, NULL, 'INSXT5', 'INSXT5', '', 2),
('b16', 1, '2025-11-27', 'Test', 1, 81, NULL, NULL, NULL, '', 2),
('b16', 2, '2025-12-12', 'Test', 2, 41, NULL, NULL, NULL, '', 2),
('b16', 3, '2025-12-12', 'Test', 3, 26, NULL, 'AMOPIL7', NULL, '', 2),
('b16', 4, '2025-12-16', 'Test coef', 1, 82, NULL, NULL, NULL, '', 1),
('b16', 5, '2025-12-16', 'Test', 2, 82, NULL, NULL, NULL, '', 2),
('b16', 6, '2025-12-16', 'Test', 2, 42, NULL, NULL, NULL, '', 1),
('b16', 7, '2025-12-16', 'azeazea', 1, 47, NULL, NULL, NULL, '', 1),
('b16', 8, '2025-12-16', 'aze', 1, 81, NULL, NULL, NULL, '', 2),
('b16', 9, '2025-11-26', 'test', 1, 43, NULL, NULL, NULL, '', 2),
('b16', 10, '2025-12-12', 'test', 1, 56, NULL, NULL, NULL, '', 2),
('b16', 11, '2025-12-12', 'test', 1, 56, NULL, NULL, NULL, '', 2),
('b16', 12, '2025-12-16', 'trest', 1, 81, NULL, NULL, NULL, '', 1),
('m35', 1, '2025-12-09', 'yuiuy', 1, 81, NULL, NULL, NULL, '', 2);
...
CREATE TABLE IF NOT EXISTS `travailler` (
  `COL_MATRICULE` varchar(10) NOT NULL,
  `REG_CODE` varchar(2) NOT NULL,
  `TRA_ROLE` varchar(50) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `type_individu` (
  `TIN_Code` int(11) NOT NULL,
  `TIN_LIBELLE` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
ALTER TABLE `rapport_visite`
  ...
  ADD CONSTRAINT `FK_Rapport_Pra` FOREIGN KEY (`PRA_NUM`) REFERENCES `praticien` (`PRA_NUM`),
  ADD CONSTRAINT `FK_Rapport_PraRempl_unique` FOREIGN KEY (`PRA_NUM_praticien`) REFERENCES `praticien` (`PRA_NUM`);
